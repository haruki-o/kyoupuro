...
#define TIME_LIMIT4 (2)
#define TIME_LIMIT1 (30)
#define TIME_LIMIT2 (55)
#define TIME_LIMIT3 (57)
...
void solve(Cube &nec_c1, Cube &sub_c1, Cube &nec_c2, Cube &sub_c2,
  ...
  while (1) {
    ...
    bool flag = (int)parts1.size() == (int)parts2.size() &&
